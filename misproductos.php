...
$sql = "
    SELECT
        ...
        nombre_producto,
        precio,
        IFNULL(NULLIF(TRIM(imagen), ''), 'bolsa.svg') AS imagen
    FROM producto
    WHERE id_proveedor = ?
...
<head>
    ...
    <title>Mis productos — Ventas de todo</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 640px) {
            ...
            .fab-subir { bottom: 20px; right: 20px; left: 20px; }
            .fab-subir .button { width: 100%; text-align: center; }
        }
...
<body>
    ...
    <header>
        <nav>
            ...
            <div class="nav-links">
                ...
                <a href="misproductos.php" class="active">MIS PRODUCTOS</a>
                <motion class="perfil-wrap">
    ...
    <section class="hero">
        <span class="hero-badge">Tu catálogo personal</span>
        <h1 class="titulo-pagina">MIS PRODUCTOS</h1>
        <p class="subtitulo">Edita o elimina las publicaciones que has subido al marketplace del plantel.</p>
    </section>

    <main class="catalogo" id="catalogo">
        <?php if (isset($_GET['ok']) && $_GET['ok'] === 'edit'): ?>
            <p class="msg ok">Publicación actualizada correctamente.</p>
        <?php elseif (isset($_GET['ok']) && $_GET['ok'] === 'del'): ?>
            <p class="msg ok">Producto eliminado.</p>
        <?php elseif (isset($_GET['error'])): ?>
            <p class="msg err">No se pudo completar la acción. Intenta de nuevo.</p>
        <?php endif; ?>
                ...
                <article class="card" style="transition-delay: <?php echo $delay; ?>ms">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions">
                            <a class="btn-edit" href="editar_producto.php?id=<?php echo $pid; ?>">Editar publicación</a>
                            <form action="eliminar_producto.php" method="post" onsubmit="return confirm('¿Eliminar este producto? Esta acción no se puede deshacer.');">
                                <input type="hidden" name="id_producto" value="<?php echo $pid; ?>">
        ...
        ?>
            <p class="vacio">No has publicado productos todavía. ¡Sube tu primero!</p>
        <?php endif; ?>
    </main>
